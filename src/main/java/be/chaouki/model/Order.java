...
public class Order extends  AbstractTableModel {
    ...
    private boolean isDiscount1Applic;
    private boolean isDiscount2Applic;
    private boolean isDiscount3Applic;
...
//        orderLineList.add(new OrderLine(ClassicPizza.ClassicPizzaType.BOLOGNESE, ClassicPizza.PizzaSize.NORMAL, 2));
    ...
    public boolean isIsDiscount1Applic() {
        return isDiscount1Applic;
    }

    public void setIsDiscount1Applic(boolean isDiscount1Applic) {
        this.isDiscount1Applic = isDiscount1Applic;
        refreshTotalPrice();
    }

    public boolean isIsDiscount2Applic() {
        return isDiscount2Applic;
    }

    public void setIsDiscount2Applic(boolean isDiscount2Applic) {
        this.isDiscount2Applic = isDiscount2Applic;
        refreshTotalPrice();
    }

    public boolean isIsDiscount3Applic() {
        return isDiscount3Applic;
    }

    public void setIsDiscount3Applic(boolean isDiscount3Applic) {
        this.isDiscount3Applic = isDiscount3Applic;
        refreshTotalPrice();
    }
...
//    }
    ...
    /** 
     * Only one discount is applicable. Only the classic pizzas are to be 
     * taken itno account.
     */
    private void refreshDiscount() {
        ...
        // ------------------------------------------------------------------
        if(isDiscount1Applic){
            final double DISCOUNT1=2.0;
            int normalPizzaCount=0;
            for(OrderLine ol : orderLineList){
                if(ol.getItem() instanceof ClassicPizza){
            ...
            if(normalPizzaCount>=2 && discount < DISCOUNT1)
                    discount=DISCOUNT1;
        }
